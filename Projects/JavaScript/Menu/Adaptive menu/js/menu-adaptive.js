...
function menu() {
    ...
    let messengers = document.querySelector('.header-messengers-box');
    let messengersMobileToggle = document.querySelector('.messengers-mobile-toggle');
    let phoneMessengersImg = document.querySelector('.phone-messengers-img');
