...
if (file_exists($filename)) { 
    ...
    $file = file_get_contents('data-0.json'); 
    // Если такого файла нет… 
} else { 
    // …то создаём его сами 
    $file = fopen("data-0.json", "a+"); 
} 
...
// file_put_contents('data-0.json', json_encode($file)); 
file_put_contents('data-0.json', json_encode($file, JSON_UNESCAPED_UNICODE | JSON_PRETTY_PRINT)); 
// …и сразу считываем их обратно 
$file = file_get_contents('data-0.json'); // Открыть файл data-0.json 
