...
// file_put_contents('data-1.json', json_encode($file)); 
file_put_contents('data-1.json', json_encode($file, JSON_UNESCAPED_UNICODE | JSON_PRETTY_PRINT)); 
// …и сразу считываем их обратно 
$file = file_get_contents('data-1.json'); // Открыть файл data-1.json 
