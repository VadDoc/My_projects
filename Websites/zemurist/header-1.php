        ...
        <nav id="site-navigation" class="container-menu">
         ...
         <?php if( have_rows('messengers', 6) ): ?>
             <div class="messangers">
                 <?php while( have_rows('messengers', 6) ): the_row(); ?>
                    <a href="<?php the_sub_field('messenger_link', 6); ?>" title="<?php the_sub_field('messenger_name', 6); ?>"><img class="messengers-logo" src="<?php the_sub_field('messenger_logo', 6); ?>"></a>
                 <?php endwhile; ?>
             </div>
         <?php endif; ?>
         <div class="menu-mobile-logo">
            <a href="/">
               <img class="menu-mobile-logo-img" src="<?php echo get_template_directory_uri() . '/images/zemurist_logo.png' ?>">
            </a>
         </div>
