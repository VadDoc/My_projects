    		...
    		<div class="mainpage-main">
				...
				<div class="archive-posts">
                    ...
                    <?php if (category_description()): ?>
                        <?php if (!empty($h1)){ ?>
                            <h1 class="cat-title-descr darkblue"><?php  echo $h1 ?></h1>
                        <?php }else{ ?>
                            <h1 class="cat-title-descr darkblue"><?php  echo single_cat_title(); ?></h1>
                        <?php } ?>
    
                        <div class="news w100 category">
                    	    <div class="cat-descr"><?php echo category_description(); ?></div>
                            <!-- <div class="divider clearfix cat-div"></div>  -->
                      <?php else: ?>
